...
`Inheritance หรือ การรับทอด` คือความสัมพันธ์ระหว่างคลาสประเภทหนึ่ง ช่วยให้การเรียกใช้ฟังก์ชันของคลาสที่มีอยู่แล้ว 
กลายเป็นmethod [สมาชิกอีกแบบหนึ่งของคลาสและ struct ทาหน้าที่เป็นตัวประมวลผลเพื่อให้เกิด การทางานตามความต้องการ]ของคลาสตัวเอง
และสามารถเพิ่มตัวแปรและปรับแต่งฟังก์ชันนั้นให้เข้ากับสถานการ์ใหม่

## Base class & Derived class :page_with_curl:

- `Base class` (คลาสฐาน) คลาสที่มีความทั่งไปไม่เฉพาะเจาะจง 
*จะมีฟังก์ชันของการทำงานหลายคลาส และในแต่ละคลาสต้องมีฟังก์ชันเหมือนกัน*
เป็นคลาสที่งใช้รวบรวมคลาสที่มีฟังก์ชันเหมือนกัน รวมอยู่ด้วยกัน
...
- `Derived class` (คลาสอนุพันธ์) คลาสที่ต่อยอดมาจากคลาสฐาน เป็นคลาสที่มีความเฉพาะเจาะจง 
มีการรับทอดตัวแปรดาต้าเมมเบอร์และเมมเบอร์ฟังก์ชันจากคลาสฐาน อาจจะมีการปรับแต่งให้ฟังก์ชันมีความเฉพาะเจาะจงมากขึ้น
[subclass , child class]

```
class DerivedClassName : pulic BaseClassName
{
    ...
}
```
...
การที่นำคลาสอนุพันธ์ ส่วนชื่อฟังก์ชันและพารามิเตอร์ ที่เหมือนกับคลาสฐานมาปรับแต่งเพื่อให้มีการทำงานแบบเฉพาะเจาะจงมากขึ้น
ในการปรับแต่งเมมเบอร์ฟังก์ชันแบ่งเป็นสองแบบ
*จะให้ผลการทำงานแตกต่างกันเมื่อมีการใช้พอยน์เตอร์ และการประกาศพอยน์เตอร์ให้เป็นประเภทของคลาสฐาน แต่กลับให้ชี้ไปที่วัตถุของคลาสฐานแทน*
...
`redefine` จะทำได้เมื่อคลาสฐานไม่มีการใช้ virtual

:printer: Output

```
Toob is woofing
Toob is making nosise
```

#### Static

`Static type` ประเภทข้อมูลตามที่ประกาศไว้ในคลาสฐานของตัวแปรพอยน์เตอร์ 
*ไม่สามารถเปลี่ยนแปลงได้เลยตลอดการทำงาน* 
จะต้องเรียกใช้เมมเบอร์ฟังก์ชันจากคลาสในclass hierarchy ตัวแปรผูกมัดนี้จะอยู่ตลอดการทำงานของพอยน์เตอร์
...
`override` จะทำได้เมื่อคลาสฐานมีการใช้ virtual
...
`Dynamic type` ประเภทข้อมูลตามวัตถุจริงที่พอยน์เตอร์กำลังใช้งานขณะที่โปรแกรมกำลังทำงานอยู่ 
*สามารถเปลี่ยนแปลงได้ขึันอยู่กัยพอยน์เตอร์* 
จะเกิดขึ้นเมื่อมีการประกาศพอยน์เตอร์ด้วยประเภทข้อมูลในคลาสฐาน และมีการเรียกใช้virtualจากพอยน์เตอร์

## Inheritance with data member & member function :page_with_curl:

- คลาสอนุพันธ์ได้รับทอดมาจากคลาสฐาน ทำให้ดาต้าเมมเบอร์และเมมเอบณืฟังก์ชันทั้งหมดจากคลาสฐาน *การเข้าถึงจะขึ้นอยู่กับaccess modifierของคลาสฐาน*

- เพื่อให้คลาสอนุพันธ์มีความเฉพาะเจาะจงมากขึ้นและตรงกับการใช้งาน 
ดังนั้นเราสามารถเพิ่มดาต้าเมมเบอร์และเมมเบอร์ฟังก์ชันใหม่ได้ 
และสามารถปรับแต่งเมมเบอร์ฟังก์ชันได้อีกด้วย

## benefits of inheritance :page_with_curl:

- ช่วยให้คลาสอนุพันธ์ใช้ดาต้าเมมเบอร์และเมมเบอร์ฟังก์ชันของคลาสฐานเหมือนกับคลาสอนุพัธ์ทำให้ไม่ต้องประกาศใหม่ ลดความซ้ำซ้อน ลดความพิมพลาดในการเขียน ทำให้โปรแกรมยืดหยุ่น ปรับแก้ไขหรือเพิ่มการทำานได้ง่ายขึ้น

## Polymorphism (ภาวะพหุสัณฐาน) :page_with_curl:

ภาวะการโปรแกรมที่มีคำสั่งเดียวกัน แต่ต่างสถานการณ์กันและทำงานต่างกัน

**ประโยชน์ของภาวะพหุสัณฐาน**

- โปรแกรมมีความยืดหยุ่น สามารถรองรับได้หลายสถานการณ์ด้วยคำสั่งชุดเดียวกัน

### Subtype Polymorphism :pencil2:

เกิดจากการรับทอด และไม่มีการระบุประเภท เกิดได้เมื่อคลาสอนุพันธ์ปรังแต่งเมมเบอร์ฟังก์ชันของคลาสฐานแบบ*Override* มีการประกาศvirtual และใช้พอยน์เตอร์ที่ประเภทข้อมูลของคลาสฐาน

`greet()`จะไม่รู้ว่าพารามิเตอร์ที่ถูกส่งเข้ามาเป็นของคลาสไหน และไม่สามารถระบุใบช่วงการคอมไพล์ว่าจะต้องเรียกเมมเบอร์ฟันก์ชันจากคลาสใน class hierarchy

ขณะประมวลผลโปรแกรม greetจะรู้ว่าdynamic typeของพอยน์เตอร์ว่าวัตถุจริงมาจากคลาสไหน และมีการเปลี่ยนแปลงได้เมื่อเราส่งวัตถุจากคลาสต่างๆเข้ามาที่พารามิเตอร์ ผลการรันจะต่างกัน
